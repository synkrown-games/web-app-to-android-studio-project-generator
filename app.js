...
(function (root) {
    ...
    function mainActivity(pkg, opts) {
        ...
        if (fullscreen) {
            add('');
            add('import androidx.core.view.WindowCompat;');
            add('import androidx.core.view.WindowInsetsCompat;');
            add('import androidx.core.view.WindowInsetsControllerCompat;');
        }
        ...
        if (fullscreen) {
            add('');
            add('        WindowCompat.setDecorFitsSystemWindows(getWindow(), false);');
            add('        WindowInsetsControllerCompat insetsController =');
            add('                new WindowInsetsControllerCompat(getWindow(), getWindow().getDecorView());');
            add('        insetsController.hide(WindowInsetsCompat.Type.systemBars());');
            add('        insetsController.setSystemBarsBehavior(');
            add('                WindowInsetsControllerCompat.BEHAVIOR_SHOW_TRANSIENT_BARS_BY_SWIPE);');
        }
...
// ---------------------------------------------------------------------------
// DOM glue below. Everything above this line is pure logic (AndroidWrapper),
